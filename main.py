...
# 2. UPLOAD/CLEAN PAGE - YOUR EXACT CODE. NOTHING CHANGED
UPLOAD_PAGE = """
<!DOCTYPE html>
<html>
<head>
  <title>Cleaning - TruthGuard AI Pro</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <style>
    body {{ 
...
# 3. PRICING PAGE - NEW WITH 4 PLANS
PRICING_PAGE = """
<!DOCTYPE html>
<html>
<head>
  <title>Pricing - TruthGuard AI Pro</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <style>
    body {{ font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial; background: #0f172a; color: white; margin: 0; padding: 0; }}
   .container {{ max-width: 700px; margin: 0 auto; padding: 20px; text-align: center; }}
   ...
   .price-card.pro {{ border: 2px solid #38bdf8; }}
    button {{ padding: 10px 20px; background: #2563eb; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold; width: 100%; }}
  </style>
</head>
<body>
{NAV}
...
# ADDED: /clean is your original page
