...
.shield{font-size:3em;text-align:center;margin:10px 0}
...
.credits{background:#1a1a1a;padding:12px 25px;border-radius:25px;display:inline-block;margin:10px 0;font-size:1.1em}
input,textarea{width:100%;padding:14px;margin:12px 0;border-radius:10px;border:1px solid #333;background:#1a1a1a;color:#fff;box-sizing:border-box;font-size:1em}
...
<button class="btn" name="method" value="transfer">Pay with Transfer</button>
<button class="btn" name="method" value="bank">Pay with Bank</button>
<button class="btn" name="method" value="ussd">Pay with USSD</button>
</form>
<p style="text-align:center;font-size:0.9em;color:#aaa;margin-top:15px">Secured by Paystack Live</p>
</div><br><a href="/" style="color:#00ff88">← Back Home</a></div></body></html>"""
