...
def home():
    ...
    <body>
        ...
        <div class="plan">
          <h3>Starter</h3>
          <p><b>₦7,500</b> for 500 Data Cleaning</p>
          <button class="btn" style="background:#00C3FF;color:#000" onclick="pay(7500,500)">Pay ₦7,500</button>
        </div>

        <!-- PLAN 2: 1K -->
        <div class="plan">
          <h3>Basic</h3>
          <p><b>₦15,000</b> for 1,000 Data Cleaning</p>
          <button class="btn" style="background:#00C3FF;color:#000" onclick="pay(15000,1000)">Pay ₦15,000</button>
        </div>
        ...
        <div class="plan popular">
          ...
          <h3>Growth</h3>
          <p><b>₦75,000</b> for 10,000 Data Cleaning</p>
          <button class="btn" style="background:#00FF88;color:#000" onclick="pay(75000,10000)">Pay ₦75,000</button>
        </div>

        <!-- PLAN 4: 20K -->
        <div class="plan">
          <h3>Enterprise</h3>
          <p><b>₦150,000</b> for 20,000 Data Cleaning</p>
          <button class="btn" style="background:#00C3FF;color:#000" onclick="pay(150000,20000)">Pay ₦150,000</button>
        </div>
        ...
        function pay(amount, claims) {
          var handler = PaystackPop.setup({
            ...
            amount: amount * 100, // Paystack uses kobo. ₦7,500 = 750000
            currency: 'NGN',
            ref: 'TG_' + Date.now(),
